...
def turnOnFan(roomId,deviceType,status):
    ...
    if(roomId=="1" and deviceType=="2" and status=="1"):
        ...
        #pwm33.stop()
    #pwm35.start(50)
    if(roomId=="1" and deviceType=="2" and status=="2"):
        pwm33.start(60)
        #time.sleep(10) 
        #pwm33.stop()
    if(roomId=="1" and deviceType=="2" and status=="3"):
        pwm33.start(70)
        #time.sleep(10) 
        #pwm33.stop()
    if(roomId=="1" and deviceType=="2" and status=="4"):
        pwm33.start(85)
        #time.sleep(10) 
        #pwm33.stop()
    if(roomId=="1" and deviceType=="2" and status=="5"):
        pwm33.start(100)
        #time.sleep(10) 
        #pwm33.stop()
    #else:
